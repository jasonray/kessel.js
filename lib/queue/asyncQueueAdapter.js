...
QueueAdapter.prototype.initialize = function (callback) {
    var self = this;
    setTimeout(function () {
...
QueueAdapter.prototype._isConnected = function () {
    var self = this;
...
QueueAdapter.prototype.dequeue = function (callbackToConsumer) {
    ...
    setTimeout(function () {
        ...
        if (_.isEmpty(jobRequest)) {
            ...
            callbackToConsumer(jobRequest, self._commitCallback(jobRequest).bind(self), self._rollbackCallback(jobRequest).bind(self));
        }
    }, self.simulatedLatency);
};

QueueAdapter.prototype._commitCallback = function (jobRequest) {
...
QueueAdapter.prototype._rollbackCallback = function (jobRequest) {
    var self = this;
