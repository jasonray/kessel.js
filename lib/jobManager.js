...
JobManager.prototype.registerHandler = function (type, handler) {
    var self = this;

    if (_.isEmpty(type)) throw new Error('Cannot register handler with invalid type');
...
JobManager.prototype.initialize = function (callback) {
    var self = this;
...
JobManager.prototype._isInitialized = function () {
    var self = this;
...
JobManager.prototype._determineQueueAdapter = function () {
    var self = this;
...
JobManager.prototype._getHandler = function (type) {
    var self = this;
