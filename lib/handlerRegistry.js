...
HandlerRegistry.prototype.registerHandlers = function (handlersInfo) {
    _.each(handlersInfo, function (handlersInfo) {
        self.registerHandler(handlersInfo.type, handlersInfo.handler);
    });
};
